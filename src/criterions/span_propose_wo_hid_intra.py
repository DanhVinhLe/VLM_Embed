...
class SpanProposeCriterionWeightedWOHidIntra(nn.Module):
    def __init__(self, args):
        super(SpanProposeCriterionWeightedWOHidIntra, self).__init__()
    ...
    def forward(self, distiller, input_data, tokenizer):
        ...
        # ============ Tổng hợp loss ============
        total_loss = contrastive_loss + self.w_cross_modal * cross_modal_loss + (self.args.kd_weight / 10.0) * rkd_loss
