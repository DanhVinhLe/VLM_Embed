...
class SpanProposeCriterionWeightedOnlyWord(nn.Module):
    def __init__(self, args):
        super(SpanProposeCriterionWeightedOnlyWord, self).__init__()
        ...
        for i in range(batch_size):
            ...
            if has_image_qry:
                ...
                (qry_vision_loss, vision_cluster_info_words_qry, student_vision_mapping_words_qry,
                 vision_cluster_info_words_qry, student_vision_mapping_words_qry) = compute_vision_cluster_loss_weighted(
                    projectors,
            ...
            if has_image_pos:
                ...
                (pos_vision_loss, vision_cluster_info_words_pos, student_vision_mapping_words_pos,
                 vision_cluster_info_words_pos, student_vision_mapping_words_pos) = compute_vision_cluster_loss_weighted(
                    projectors,
