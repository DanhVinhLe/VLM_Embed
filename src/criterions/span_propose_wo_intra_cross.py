...
class SpanProposeCriterionWeightedWOIntraCross(nn.Module):
    def __init__(self, args):
        super(SpanProposeCriterionWeightedWOIntraCross, self).__init__()
    ...
    def forward(self, distiller, input_data, tokenizer):
        ...
        # ============ Tổng hợp loss ============
        total_loss = contrastive_loss + self.args.kd_weight * span_loss + (self.args.kd_weight / 10.0) * rkd_loss
